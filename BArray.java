...
public class BArray<T extends Comparable<T>>
{
	...
	public void add(T item, int i)	//the ith element(i starts from 0)
	{
	...
	public void delete(int i)	//the ith element(i starts from 0)
	{
		if (i>numOfElement)
	...
	public T get(int i)		//i starts from 0
	{
		if (i>numOfElement)
			throw new ArrayIndexOutOfBoundsException();
	...
	public void set(T item, int i)		//i starts from 0
	{
		if (i>numOfElement)
			throw new ArrayIndexOutOfBoundsException();
